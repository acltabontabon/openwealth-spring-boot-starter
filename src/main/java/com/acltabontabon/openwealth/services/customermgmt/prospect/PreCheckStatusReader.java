...
public class PreCheckStatusReader extends ReadCommand<OperationResult<ProspectResponse>> {
    ...
    protected OperationResult<ProspectResponse> execute()  {
        try {
            ...
            return OperationResult.failure("Failed to fetch prospect pre-check status", e.getStatusMessage());
        }
    }
}
